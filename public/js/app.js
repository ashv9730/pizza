...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("http://localhost:3000/admin/orders", {
    headers: {
...
function placeOrder(formObj) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/orders", formObj).then(function (res) {
    console.log(res.data);
...
order = JSON.parse(order); // console.log('order',order)
...
updateStatus(order); // payment form
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(socket); // admin
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, paymentType, elements, card, paymentForm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__.loadStripe)("pk_test_51JYOOdSG2e8tIYNjSfFB9SzZ8n3T6rO5sk7e6gQYI6DTqngdys0cyIztV4qbUpNvNZRNpBTQYmn3ijyGjIUWCKt100fMfEVptC");
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener("submit", function (e) {
                ...
                if (!card) {
                  (0,_apiService__WEBPACK_IMPORTED_MODULE_3__.placeOrder)(formObj); // console.log(formObj)
                ...
                stripe.createToken(card).then(function (result) {
                  ...
                  (0,_apiService__WEBPACK_IMPORTED_MODULE_3__.placeOrder)(formObj);
                })["catch"](function (err) {
                  console.log(err);
                });
              });
